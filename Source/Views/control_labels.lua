...
local STATE_INIT, STATE_REC, STATE_PLAY_READY, STATE_PLAYING_LOOPER, STATE_PLAYING_EFFECTS = 0, 1, 2, 3, 4
...
function ControlLabels:setReady()
	if(self.state == STATE_INIT)then return end
